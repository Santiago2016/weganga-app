...
}]).controller('AdminProveedorListController', ['$scope', '$state', '$http',function ($scope, $state, $http) {
...
}]).controller('AdminImpuestoListController', ['$scope', '$http', function ($scope, $http) {
...
}]).controller('AdminOfertaListController', ['$scope', '$http', function ($scope, $http) {
...
}]).controller('AdminReglaCarritoListController', ['$scope', '$http', function ($scope, $http) {
...
}]).controller('AdminReglaPromocionListController', ['$scope', '$http', function ($scope, $http) {
...
}]).controller('AdminVentaListController', ['$scope', '$http', function ($scope, $http) {
...
}]).controller('AdminUsuarioListController', ['$scope', '$state', '$http',function ($scope, $state, $http) {
...
}]).controller('AdminCategoriaListController', ['$scope', '$state', '$http',function ($scope, $state, $http) {
...
}]).controller('VendedorCrearOfertaController', ['$scope', '$state', function ($scope, $state) {

}]).controller('VendedorEditarOfertaController', ['$scope', '$state', function ($scope, $state) {

}]).controller('VendedorListOfertaController', ['$scope', '$http', function ($scope, $http) {
    $http.get('http://localhost:8080/Weganga/web/app_dev.php/api/offers').then(function (response) {
        $scope.response = response.data;
    }, function (err) {
        $scope.err = err;
...
}]).controller('VendedorEditarCategoriaController', ['$scope', '$state', '$stateParams', '$http', function ($stateParams, $scope, $state, $http) {
    $http.get('http://localhost:8080/Weganga/web/app_dev.php/api/categorias/'+$stateParams.id).then(function (response) {
        var resp = response.data;
        $scope.categoria = resp.categorys;
    },function (err) {
...
}]).controller('VendedorListCategoriaController', ['$scope', '$state', '$http', function ($scope, $state, $http) {
    $http.get('http://localhost:8080/Weganga/web/app_dev.php/api/categorias').then(function (response) {
        $scope.response = response.data;
    }, function (err) {
        $scope.err = err;
